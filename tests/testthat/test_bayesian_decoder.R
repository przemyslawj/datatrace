...
test_that('to_1dim succeeds', {
  expect_equal(to_1dim(0, 0, nbins.y=20), 1)
  expect_equal(to_1dim(0, 1, nbins.y=20), 2)
  expect_equal(to_1dim(1, 0, nbins.y=20), 21)
}) 

test_that('from1dim succeeds', {
  expect_equal(from_1dim(1, 20), list(x=0, y=0))
  expect_equal(from_1dim(2, 20), list(x=0, y=1))
  expect_equal(from_1dim(21, 20), list(x=1, y=0))
}) 
